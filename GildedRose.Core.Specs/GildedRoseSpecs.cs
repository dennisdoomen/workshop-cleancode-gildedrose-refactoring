...
public class GildedRoseSpecs
{
    ...
    public void After_one_day(string name, int startingSellIn, int startingQuality, int expectedSellIn,
        int expectedQuality)
    {
        // Arrange
    ...
    public void After_three_days(string name, int startingSellIn, int startingQuality, int expectedSellIn,
        int expectedQuality)
    {
        // Arrange
        GildedRose gildedRose = new();
        ...
        // Act
        for (var day = 0; day < 3; day++) gildedRose.UpdateQuality(new List<Item> { item });
    ...
    public void After_ten_days(string name, int startingSellIn, int startingQuality, int expectedSellIn,
        int expectedQuality)
    {
        // Arrange
        GildedRose gildedRose = new();
        ...
        // Act
        for (var day = 0; day < 10; day++) gildedRose.UpdateQuality(new List<Item> { item });
    ...
    public void Backstage_passes_increase_in_quality_quickly_until_they_are_due(int daysPassed, int expectedQuality)
    {
        ...
        var nrDaysUntilConcert = 20;

        Item item = new("Backstage passes to a TAFKAL80ETC concert", nrDaysUntilConcert, 10);

        // Act
        for (var day = 0; day < daysPassed; day++) gildedRose.UpdateQuality(new List<Item> { item });
